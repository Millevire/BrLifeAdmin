...
public class AlertNuevoMantenedorDosAtributos {
    ...
    public AlertNuevoMantenedorDosAtributos(final Context contexto, final AdaptaderTipoProducto actividad, final boolean tipo, final TipoProducto tipoProducto, final String mantenedor) {
        interfaz= actividad;
        ...
        //widget
        Button btnAceptarAlertNuevoMantenedorDosAtributos=dialogo.findViewById(R.id.btnAceptarAlertNuevoMantenedorDosAtributos);
...
//validar tpo de de accion para dialogo, true=editar false=agregar nuevo registro
        if (tipo==true){
            ...
            tvTitutloAlertNuevoMantenedorDosAtributos.setText("Editar");
        }


        //Accion boton Aceptar
        btnAceptarAlertNuevoMantenedorDosAtributos.setOnClickListener(new View.OnClickListener() {
            @Override
