...
public class AlertNuevoMantenedor {
    ...
    public AlertNuevoMantenedor(final Context contexto, final AdaptaderTipoProducto actividad, final boolean tipo, final TipoProducto tipoProducto, final String mantenedor) {
        interfaz= actividad;
